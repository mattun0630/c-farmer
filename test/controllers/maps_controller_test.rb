...
class MapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post maps_url, params: { map: { address: @map.address, comment: @map.comment, lonlat: @map.lonlat } }
    end
  ...
  test "should update map" do
    patch map_url(@map), params: { map: { address: @map.address, comment: @map.comment, lonlat: @map.lonlat } }
